...
## cluster.
gsutil cp dataproc_initialization_sparkapply.sh gs://${GCS_BUCKET}/rstudo-sparklyr/dataproc_initialization_sparkapply.sh
...
gcloud beta dataproc \
  ...
  --initialization-actions gs://${GCS_BUCKET}/rstudo-sparklyr/dataproc_initialization_sparkapply.sh \
